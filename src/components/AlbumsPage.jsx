...
const AlbumsPage = () => {
  const albums = [
    ...
    {
      id: 3,
      title: "Wedding Classics Remixed",
      artist: "DJ Gmoney",
      status: "Post-Production",
      releaseDate: "Fall 2026",
      cover: "https://images.unsplash.com/photo-1514525253440-b39345208668?q=80&w=2070&auto=format&fit=crop",
      genre: "Dance / Top 40"
    },
    {
      id: 4,
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            A sneak peek into upcoming projects, mixtapes, and exclusive productions currently in the works.
          </p>
        </motion.div>
